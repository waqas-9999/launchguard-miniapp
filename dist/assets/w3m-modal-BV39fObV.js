import{g as v,h as f,x as a,ap as d,n as w,av as M}from"./index-CrAQh-3d.js";import{k as pe,p as me,s as he,l as ve,M as g,S as ee,R as l,h as E,A as j,j as te,i as ie,C as m,m as H,n as fe,o as k,E as G,O as T,q as V,u as F,v as $,x as D,T as ge,y as be,z as ye,B as xe}from"./core-CZ-n-4YL.js";import{c as u,U as Ce}from"./index-ra6ezOYn.js";import"./index.es-CtmeZkQO.js";const p=me({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),ke={state:p,subscribe(r){return ve(p,()=>r(p))},subscribeKey(r,e){return he(p,r,e)},showTooltip({message:r,triggerRect:e,variant:t}){p.open=!0,p.message=r,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},A=pe(ke),oe={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await ee.isSIWXCloseDisabled()){g.shake();return}g.close()}},Se=v`
  :host {
    display: block;
